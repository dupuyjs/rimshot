...
namespace Songkick
{
    public interface ISongkickClient
    {
        ...
        Task<ContentResponse> UpcomingEventSearch(int metroAreaId, int? page = 1, int? perPage = 20);
        ...
        Task<ContentResponse> ArtistPastEvents(ArtistType artist, int? page = 1, int? perPage = 20, OrderTypeEnum order = OrderTypeEnum.Ascending);
